...
| Existing APP clients | external clients such as `/home/user/ncg/agent.py` | stdio or Unix socket APP JSON-RPC | Non-OpenClaw agents that want stable privacy RPCs plus agent/session telemetry |
