    ...
    const all = [
      ...
      // the re-obfuscation path after OC compacts earlier messages
      {
        ...
        turns: [
          ...
          { message: "Escalate to +353861234567 about the outage on 10.255.0.1", realValues: ["172.16.5.10", "noc@infra-corp.net", "10.255.0.1", "+353861234567"] },
          { message: "Also notify ops@infra-corp.net about 192.168.1.50 being down", realValues: ["172.16.5.10", "noc@infra-corp.net", "10.255.0.1", "+353861234567", "ops@infra-corp.net", "192.168.1.50"] },
        ],
      },
      {
        ...
        turns: [
          ...
          { message: "Also check 10.0.2.11 with API key sk-ant-api03-abc123XYZ", realValues: ["10.0.2.10", "10.0.2.11", "sk-ant-api03-abc123XYZ"] },
      ...
      // after OpenClaw compacts earlier messages.
      {
        ...
        turns: [
          ...
          { message: "Also page the on-call at +442071234567", realValues: ["10.20.30.40", "noc-lead@datacenter-ops.net", "+442071234567"] },
          { message: "The backup server is at 172.31.255.10", realValues: ["10.20.30.40", "noc-lead@datacenter-ops.net", "+442071234567", "172.31.255.10"] },
          { message: "Failover API key is sk-proj-failover9876xyz543abc210def098ghi765", realValues: ["10.20.30.40", "noc-lead@datacenter-ops.net", "+442071234567", "172.31.255.10", "sk-proj-failover9876xyz543abc210def098ghi765"] },
          { message: "Send incident report to postmortem@datacenter-ops.net", realValues: ["10.20.30.40", "noc-lead@datacenter-ops.net", "+442071234567", "172.31.255.10", "sk-proj-failover9876xyz543abc210def098ghi765", "postmortem@datacenter-ops.net"] },
        ],
      },
      {
      ...
      },
      {
        ...
        turns: [
          ...
          { message: "Gateway API key is sk-ant-api03-payGW9xz8w7v6u5t4", realValues: ["finance@acme-billing.com", "10.88.2.100", "sk-ant-api03-payGW9xz8w7v6u5t4"] },
          { message: "Refund to IBAN DE89370400440532013000 for order 7789", realValues: ["finance@acme-billing.com", "10.88.2.100", "sk-ant-api03-payGW9xz8w7v6u5t4", "DE89370400440532013000"] },
          { message: "Call the merchant at +61412345678 to confirm", realValues: ["finance@acme-billing.com", "10.88.2.100", "sk-ant-api03-payGW9xz8w7v6u5t4", "DE89370400440532013000", "+61412345678"] },
        ],
      },
      {
      ...
      },
      {
        ...
        turns: [
          ...
          { message: "AWS access key for CI is AKIAIOSFODNN7EXAMPLE and prod DB is 10.70.3.10", realValues: ["10.70.3.5", "AKIAIOSFODNN7EXAMPLE", "10.70.3.10"] },
          { message: "Alert devops-oncall@platform-team.io about the rotation", realValues: ["10.70.3.5", "AKIAIOSFODNN7EXAMPLE", "10.70.3.10", "devops-oncall@platform-team.io"] },
        ],
      },
    ...
    if (process.env.SHROUD_TEST_SANDBOX === "1") {
      all.push(
        ...
        },
        {
          ...
          message: "Use API key sk-ant-api03-sandbox9xyz8w7v6u to query the endpoint at 10.90.0.5",
          realValues: ["sk-ant-api03-sandbox9xyz8w7v6u", "10.90.0.5"],
        },
        {
