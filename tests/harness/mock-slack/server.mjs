  ...
  return new Promise((resolve) => {
    ...
    req.on("end", () => {
      ...
      if (path === "/api/chat.postMessage") {
        ...
        const users = {
          "U00000001": { id: "U00000001", name: "walter.keating", real_name: "Shroud Maintainers", is_bot: false, tz: "Europe/Dublin" },
        ...
        json(res, {
          ok: true,
          members: [
            { id: "U00000001", name: "walter.keating", real_name: "Shroud Maintainers", is_bot: false },
